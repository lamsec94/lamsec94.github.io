...
![Project Architecture Diagram](./media/image13.png)  
...
![Container List (Portainer/Dashboard View)](./media/image3.png)  
...
![Terminal Commands and Service Logs](./media/image8.png)  
...
![Suricata Log Tail (eve.json)](./media/image5.png)  
...
![Zeek Logs Directory Listing](./media/image7.png)  
...
![DVWA Web Interface](./media/image9.png)  
**DVWA Web Interface**  
...
![DVWA SQL Injection Exploit](./media/image6.png)  
...
![Grafana Home Page](./media/image4.png)  
**Grafana Home Page**  
...
![Grafana Data Sources Page](./media/image2.png)  
...
![Grafana Dashboard ("Cyber Lab Monitoring --- SOC Log View")](./media/image10.png)  
...
![Docker Stats Output](./media/image1.png)  
**Docker Stats Output**  
...
![Ntopng Dashboard](./media/image12.png)  
**Ntopng Dashboard**  
...
![Terminal - Network Commands](./media/image11.png)  
